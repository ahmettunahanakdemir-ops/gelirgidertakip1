...
const CACHE_NAME = "akis-butce-v299";
// ACIKLAMA: Uygulamanin cevrimdisi acilmasi icin cachelenecek temel dosyalari listeler.
const APP_ASSETS = [
  "./",
  "./index.html",
  "./assets/css/01-base.css?v=299",
  "./assets/css/02-auth-forms.css?v=299",
  "./assets/css/03-shell-navigation.css?v=299",
  "./assets/css/04-dashboard-history-export.css?v=299",
  "./assets/css/05-modals-payment-splash.css?v=299",
  "./assets/css/06-mobile-payment-assets.css?v=299",
  "./assets/css/07-theme-settings.css?v=299",
  "./assets/css/08-modal-filters-home.css?v=299",
  "./assets/css/09-bank-import-filters-wide.css?v=299",
  "./assets/css/10-responsive-pwa-overrides.css?v=299",
  "./assets/css/11-bulk-recent-final.css?v=299",
  "./assets/css/12-debts-receivables.css?v=299",
  "./assets/js/00-theme-preload.js?v=299",
  "./firebase-config.js?v=299",
  "./assets/js/01-config-dom.js?v=299",
  "./assets/js/02-ui-preferences-reminders.js?v=299",
  "./assets/js/03-init-entry-forms.js?v=299",
  "./assets/js/04-storage-home-render.js?v=299",
  "./assets/js/05-assets-payments-bes-market.js?v=299",
  "./assets/js/06-summary-history-categories-navigation.js?v=299",
  "./assets/js/07-backup-export-import-sync.js?v=299",
  "./assets/js/08-auth-firebase-cloud.js?v=299",
  "./assets/js/09-bank-import-ocr-parsers.js?v=299",
  "./assets/js/10-debts-receivables.js?v=299",
  "./assets/js/10-startup-pwa.js?v=299",
  "./assets/js/11-state-startup.js?v=299",
  "./manifest.json?v=299",
  "./icon.svg",
  "./icon-180.png",
  "./icon-512.png",
